...
// B0 << U
impl<H: NonZero + Default> Shl<Z0> for B0<H> {// B0 << Z0
    type Output = Self;
    fn shl(self, _: Z0) -> Self::Output {
        self
    }
...
impl<H: NonZero + Default> Shl<P1> for B0<H> {// B0 << P1
    type Output = B0<B0<H>>;
    fn shl(self, _: P1) -> Self::Output {
        B0::new()
    }
...
impl<H: NonZero + Default, R: Unsigned + NonZero + NonOne + Sub1> Shl<R> for B0<H>
where
...
// B1 << U
impl<H: NonZero + Default> Shl<Z0> for B1<H> {// B1 << Z0
    type Output = Self;
    fn shl(self, _: Z0) -> Self::Output {
        self
    }
...
impl<H: NonZero + Default> Shl<P1> for B1<H> {// B1 << P1
    type Output = B0<B1<H>>;
    fn shl(self, _: P1) -> Self::Output {
        B0::new()
    }
...
impl<H: NonZero + Default, R: Unsigned + NonZero + NonOne + Sub1> Shl<R> for B1<H>
where
