...
impl<H: NonZero  + Default + NonNegOne + Not<Output: NonZero + Default>> Not for B0<H> { // B0<H> (...0) 的按位取反
...
impl<H: NonZero + Default + Not<Output: NonZero + Default>> Not for B1<H> { // B1<H> (...1) 的按位取反
